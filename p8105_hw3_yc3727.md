...
weekday\_vs\_weekend. There are a total of 50400 rows and 6 columns in
the final dataset.
...
specifically, it seems like the patient is more active during the day on
Sundays and more active in the evening on Fridays. Therefore, we can
conclude that the time at which the patient is more active seems to
depend on which day of the week it is and the time of the day.
...
and there is a distinct difference in the average maximum temperatue in
...
January compared to July. There seems to be outliars in January of 1982
